...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Random Image by Woxly.de</title>
        <meta name="description" content="Discover random images on Woxly.de." />
  ...
  />`}
        ...
        <div className="max-w-lg mx-5">
          ...
          <p className="text-lg text-gray-700 mb-5">
            The main feature of this site is the API, which lets you render a random image almost
            anywhere on the web.
          </p>
      ...
      <section id="uses" className="flex flex-wrap items-center justify-center py-20 px-5 bg-white">
        <div className="max-w-lg mx-5">
          ...
          <ul className="list-disc list-inside text-lg text-gray-700">
            <li className="mb-3">Image of the day websites.</li>
            <li className="mb-3">Random app backgrounds.</li>
            <li className="mb-3">Random memes.</li>
          </ul>
        </div>
        <div className="max-w-lg mx-5 mt-10 md:mt-0">
          <Image
      ...
      <footer className="bg-gray-800 text-gray-400 py-5 text-center">
        <p>
          ...
          <a className="hover:text-blue-300" href="https://woxly.de">
            Woxly.de
          </a>{' '}
          All rights reserved.
        </p>
