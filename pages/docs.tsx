...
const categories = ['nature-image', 'nature-2000', 'night-sky', 'skeleton-random-image', 'swag-wallpaper'];
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 py-12">
        <div className="container mx-auto px-4 mt-16">
          ...
          <p className="text-xl text-center text-gray-600 mb-12">
            Discover a world of images at your fingertips
          </p>

          <Tabs defaultValue="usage" className="w-full">
            <TabsList className="w-full h-full justify-center mb-8">
              <TabsTrigger value="usage" className="text-lg px-6 py-3">
                Usage Guide
              </TabsTrigger>
              <TabsTrigger value="examples" className="text-lg px-6 py-3">
                ...
                <CardContent>
                  ...
                  <div className="bg-gray-800 text-white p-4 rounded-md flex justify-between items-center mb-6">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        copyToClipboard(`https://random-image.woxly.de/api/${selectedCategory}`)
                      }
                    >
                  ...
                  <p className="text-gray-600">
                    Replace {'{category}'} in the API endpoint with one of the categories above to
            ...
            <TabsContent value="examples">
              <Card>
                ...
                <CardContent>
                  ...
                  <Button
                    onClick={() =>
                      window.open(`https://random-image.woxly.de/api/${selectedCategory}`, '_blank')
                    }
                    className="w-full"
                  >
                    Test the API call
